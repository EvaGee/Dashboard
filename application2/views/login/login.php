...
.tickets4u{
    ...
    <link rel="stylesheet" href="http://resources.elipa.co/icons.css">
...
<div class="panel panel-login">
	<i class="tickets4u" style="background-position: center"></i>
...
<form action="<?php echo base_url(); ?>index.php/login" method="post" >
    <div class="form-group">
        <input type="text" name="login_username" id="username" tabindex="1" class="form-control" placeholder="Phone Number" value="" required>
    </div>
    <div class="form-group">
