...
<div class="content-wrapper" >
    ...
    <div style="margin-top: -7%; display: block; margin-left: 10%">
    	...
    	<form class="stepy-validation" id="myform" action="<?php if($ticket->event_status == 0) { echo base_url(); ?>index.php/Welcome/updateTicketType/<?php echo $ticket->id; } else { echo base_url(); ?>index.php/Welcome/change_date/<?php echo $ticket->id; } ?>" method="post" enctype="multipart/form-data"  >
