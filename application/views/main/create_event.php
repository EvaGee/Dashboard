				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="title" id="title" class="form-control required" placeholder="event title">
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="venue" id="venue" class="form-control required" placeholder="event venue">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="location" id="location" class="form-control required" placeholder="event location">
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="date" name="date" id="date" class="form-control required" placeholder="event date">
						</div>
					</div>
                  <div class="col-md-3">
						<div class="form-group">
							<label>Event End Date: <span class="text-danger">*</span></label>
							<input type="date" name="end_date" id="end_date" class="form-control required" placeholder="event end date">
						</div>
					</div>
				</div>
			</fieldset>
