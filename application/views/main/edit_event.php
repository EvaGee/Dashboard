...
<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" id="title" name="title" class="form-control required" placeholder="event title" value="<?php echo $events->event_title; ?>">
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" id="venue" name="venue" class="form-control required" placeholder="event venue" value="<?php echo $events->event_venue; ?>">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" id="location" name="location" class="form-control required" placeholder="event location" value="<?php echo $events->event_coodinates; ?>">
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="date" id="date" name="date" class="form-control required" placeholder="event date" value="<?php echo $events->event_date; ?>">
						</div>
					</div>
				</div>
			</fieldset>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
                            ...
                            <input type="text" name="video_link" id="video_link" placeholder="enter youtube link" class="form-control" value="<?php echo $events->video; ?>" >
                        </div>
					</div>
					...
					<div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="file_sponsor" class="file-styled" id="file_sponsor" onchange="sponsor_logo(this.value);" id = "file_sponsor">
	...
	<div id="modalcreateticket1" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h5 class="modal-title"><p id = "preview_title"></p></h5>
